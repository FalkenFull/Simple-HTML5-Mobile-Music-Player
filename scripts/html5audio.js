...
var myaudioURL = 'http://stm2.pophostingbrasil.com:19758/;stream.mp3';
...
var html5audio = {
	play: function()
	{
		...
		myaudio.addEventListener("ended", function() {
			 ...
			 html5audio.stop();
			 // navigator.notification.alert('Falha na Transmissão. Possível erro de conexão ou Falha no nosso sistema, recarregue a página. Se o erro persistir tente novamente mais tarde.', null, 'Stream error', 'OK');
